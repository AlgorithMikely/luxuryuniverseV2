...
// Define a type for the cached Discord user
    ...
    <div className="container mx-auto p-4 text-white">
      ...
      <div className="bg-gray-800 p-4 rounded-lg mb-6">
        ...
        <form onSubmit={handleAddReviewer} className="flex flex-col sm:flex-row gap-4">
          ...
          >
            <option value="" disabled>Select a Discord User</option>
          ...
          <table className="w-full">
            <thead>
              <tr>
                ...
                <th className="text-left p-2">Submission Channel ID</th>
            ...
            <tbody>
              {reviewers.map((reviewer) => (
                <tr key={reviewer.id}>
                  <td className="p-2">{reviewer?.username || 'N/A'}</td>
                  <td className="p-2">{reviewer.discord_id}</td>
                  <td className="p-2">{reviewer.reviewer_profile?.tiktok_handle || 'N/A'}</td>
                  <td className="p-2">{reviewer.reviewer_profile?.discord_channel_id || 'Pending...'}</td>
                  <td className="p-2">
