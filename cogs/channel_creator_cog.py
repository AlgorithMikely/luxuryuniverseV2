        ...
        try:
            ...
            for reviewer in new_reviewers:
                ...
                try:
                    ...
                    # Create the submissions channel
                    submissions_channel = await category.create_text_channel("song-submissions")

                    # Create the queue list channel
                    await category.create_text_channel("queue-list")
