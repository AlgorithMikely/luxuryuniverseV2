...
async def test_create_submission(db_session: Session):
    ...
    submission = queue_service.create_submission(db_session, reviewer.id, user.id, "http://test.com")
...
async def test_get_pending_queue(db_session: Session):
    ...
    queue_service.create_submission(db_session, reviewer.id, user.id, "http://test.com")
    queue_service.create_submission(db_session, reviewer.id, user.id, "http://test2.com")
...
async def test_reviewer_isolation(db_session: Session):
    ...
    queue_service.create_submission(db_session, reviewer1.id, user1.id, "reviewer1_track")
    queue_service.create_submission(db_session, reviewer2.id, user2.id, "reviewer2_track")
...
async def test_advance_queue(db_session: Session):
    ...
    queue_service.create_submission(db_session, reviewer.id, user.id, "track1")
    queue_service.create_submission(db_session, reviewer.id, user.id, "track2")
